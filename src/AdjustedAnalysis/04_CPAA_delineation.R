...
writeOGR(output_of_cleaning[[1]], field_dir,  "low_clean_13", driver = "ESRI Shapefile")
writeOGR(output_of_cleaning[[2]], field_dir,  "med_clean_13", driver = "ESRI Shapefile")
writeOGR(output_of_cleaning[[3]], field_dir,  "high_clean_13", driver = "ESRI Shapefile")
