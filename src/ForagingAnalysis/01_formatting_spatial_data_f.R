...
scenario<-paste0(root_data_out, "/all_bombus/modified_sampled_fields/fields_within_habitat/only_active_appssampled_fields_1999_apps.shp")
...
colony<- st_transform(colony, crs(x)) #reproject to match extent of DF


colony<-st_buffer(colony, 1000)
scenarios_f<-st_intersection(x,colony)
