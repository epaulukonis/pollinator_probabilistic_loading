...
Can we used soil depth and bulk density to estimate a ug/cm2? and multiple that times the surface area? This is basically back calculating the way we converted the ug/g to that concentration in the first place,
