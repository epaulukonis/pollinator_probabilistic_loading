...
final_off_field_history_30m<-list()
final_off_field_history_60m<-list()
final_off_field_history_90m<-list()
...
start.time<-Sys.time()
final_off_field_history_30m<-lapply(dl, final_output_by_field_history_func_OFF)
end.time<-Sys.time()
time.taken <- round(end.time - start.time,2)
time.taken
final_off_field_history_90m[[simulation]]<-final_off_field_history_30m
...
start.time<-Sys.time()
final_off_field_history_60m<-lapply(dl, final_output_by_field_history_func_OFF)
end.time<-Sys.time()
time.taken <- round(end.time - start.time,2)
time.taken
final_off_field_history_60m[[simulation]]<-final_off_field_history_60m
...
start.time<-Sys.time()
final_off_field_history_90m<-lapply(dl, final_output_by_field_history_func_OFF)
end.time<-Sys.time()
time.taken <- round(end.time - start.time,2)
time.taken
final_off_field_history_90m[[simulation]]<-final_off_field_history_90m
