...
final_Illinois_by_cropsf$Label<-ifelse(final_Illinois_by_cropsf$Label == "Du Page County, Illinois","DuPage County, Illinois", final_Illinois_by_crop$Label)
final_Illinois_by_cropsf$Label<-ifelse(final_Illinois_by_cropsf$Label == "Mchenry County, Illinois","McHenry County, Illinois", final_Illinois_by_crop$Label)
...
final_Illinois_by_cropsf <- final_Illinois_by_cropsf %>%
  group_by(County, year, threshold) %>% mutate(percent = (NASSacres/sum(NASSacres))*100) #get percentage of each crop
final_Illinois_by_cropsf<-final_Illinois_by_cropsf[final_Illinois_by_cropsf$percent>5,] #get crops that make up 95% of crop area
